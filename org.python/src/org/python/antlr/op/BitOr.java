...
public class BitOr extends PythonTree {
    ...
    public static PyObject BitOr_new(PyNewWrapper _new, boolean init, PyType subtype, PyObject[]
    args, String[] keywords) {
        return new BitOr(subtype);
    }
    @ExposedMethod
    ...
    @ExposedMethod
    public final PyObject BitOr___int__() {
        return Py.newInteger(10);
    }

    @Override
    public String toStringTree() {
        return BitOr.class.toString();
    }
}
