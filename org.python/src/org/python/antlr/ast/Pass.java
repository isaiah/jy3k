...
public static final PyType TYPE = PyType.fromClass(Pass.class);
    ...
    public static PyObject Pass_new(PyNewWrapper _new, boolean init, PyType subtype, PyObject[]
    args, String[] keywords) {
        return new Pass(subtype);
    }
    ...
    public <R> boolean enter(VisitorIF<R> visitor) {
        return visitor.enterPass(this);
    }

    public <R> void leave(VisitorIF<R> visitor) {
        visitor.leavePass(this);
    }
