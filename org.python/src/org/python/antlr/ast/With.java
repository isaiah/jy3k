...
public static final PyType TYPE = PyType.fromClass(With.class);
    ...
    public static PyObject With_new(PyNewWrapper _new, boolean init, PyType subtype, PyObject[]
    args, String[] keywords) {
        return new With(subtype);
    }
    ...
    public With(Node token, java.util.List<withitem> items, java.util.List<stmt> body) {
        super(TYPE, token);
        this.items = items;
        if (items == null) {
