...
public static final PyType TYPE = PyType.fromClass(YieldFrom.class);
    ...
    public static PyObject YieldFrom_new(PyNewWrapper _new, boolean init, PyType subtype,
    PyObject[] args, String[] keywords) {
        return new YieldFrom(subtype);
    }
    ...
    public YieldFrom(Node token, expr value) {
        super(TYPE, token);
        this.value = value;
        if (this.value != null)
    ...
    public YieldFrom copy() {
        return new YieldFrom(this.getToken(), this.value);
    }
    ...
    public <R> boolean enter(VisitorIF<R> visitor) {
        return visitor.enterYieldFrom(this);
    }

    public <R> void leave(VisitorIF<R> visitor) {
        visitor.leaveYieldFrom(this);
    }
