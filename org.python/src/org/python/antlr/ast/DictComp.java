...
public static final PyType TYPE = PyType.fromClass(DictComp.class);
    ...
    public static PyObject DictComp_new(PyNewWrapper _new, boolean init, PyType subtype, PyObject[]
    args, String[] keywords) {
        return new DictComp(subtype);
    }
    ...
    public <R> boolean enter(VisitorIF<R> visitor) {
        return visitor.enterDictComp(this);
    }

    public <R> void leave(VisitorIF<R> visitor) {
        visitor.leaveDictComp(this);
    }
