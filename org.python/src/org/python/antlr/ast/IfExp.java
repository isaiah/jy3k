...
public static final PyType TYPE = PyType.fromClass(IfExp.class);
    ...
    public static PyObject IfExp_new(PyNewWrapper _new, boolean init, PyType subtype, PyObject[]
    args, String[] keywords) {
        return new IfExp(subtype);
    }
    ...
    public IfExp(Node token, expr test, expr body, expr orelse) {
        super(TYPE, token);
        this.test = test;
        if (this.test != null)
