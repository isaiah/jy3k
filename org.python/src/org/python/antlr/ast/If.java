...
public static final PyType TYPE = PyType.fromClass(If.class);
    ...
    public static PyObject If_new(PyNewWrapper _new, boolean init, PyType subtype, PyObject[] args,
    String[] keywords) {
        return new If(subtype);
    }
    ...
    public If(Node token, expr test, java.util.List<stmt> body, java.util.List<stmt> orelse) {
        super(TYPE, token);
        this.test = test;
        if (this.test != null)
