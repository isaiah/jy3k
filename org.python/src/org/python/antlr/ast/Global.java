...
public static final PyType TYPE = PyType.fromClass(Global.class);
    ...
    public static PyObject Global_new(PyNewWrapper _new, boolean init, PyType subtype, PyObject[]
    args, String[] keywords) {
        return new Global(subtype);
    }
    ...
    public Global(Node token, java.util.List<String> names) {
        super(TYPE, token);
        this.names = names;
        if (names == null) {
