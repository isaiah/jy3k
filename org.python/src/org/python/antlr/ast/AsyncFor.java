...
public static final PyType TYPE = PyType.fromClass(AsyncFor.class);
    ...
    public static PyObject AsyncFor_new(PyNewWrapper _new, boolean init, PyType subtype, PyObject[]
    args, String[] keywords) {
        return new AsyncFor(subtype);
    }
    ...
    public AsyncFor(Node token, expr target, expr iter, java.util.List<stmt> body,
