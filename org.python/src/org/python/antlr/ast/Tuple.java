...
public static final PyType TYPE = PyType.fromClass(Tuple.class);
    ...
    public static PyObject Tuple_new(PyNewWrapper _new, boolean init, PyType subtype, PyObject[]
    ...
    public Tuple(Node token, java.util.List<expr> elts, expr_contextType ctx) {
        super(TYPE, token);
        this.elts = elts;
        if (elts == null) {
