...
public static final PyType TYPE = PyType.fromClass(ImportFrom.class);
    ...
    public static PyObject ImportFrom_new(PyNewWrapper _new, boolean init, PyType subtype,
    PyObject[] args, String[] keywords) {
        return new ImportFrom(subtype);
    }
    ...
    public ImportFrom(Node token, String module, java.util.List<alias> names, Integer level) {
        super(TYPE, token);
        this.module = module;
        this.names = names;
        if (names == null) {
    ...
    public <R> boolean enter(VisitorIF<R> visitor) {
        return visitor.enterImportFrom(this);
    }

    public <R> void leave(VisitorIF<R> visitor) {
        visitor.leaveImportFrom(this);
    }
