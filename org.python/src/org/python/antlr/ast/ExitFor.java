...
public static final PyType TYPE = PyType.fromClass(ExitFor.class);
    ...
    public static PyObject ExitFor_new(PyNewWrapper _new, boolean init, PyType subtype, PyObject[]
    args, String[] keywords) {
        return new ExitFor(subtype);
    }
    ...
    public <R> boolean enter(VisitorIF<R> visitor) {
        return visitor.enterExitFor(this);
    }

    public <R> void leave(VisitorIF<R> visitor) {
        visitor.leaveExitFor(this);
    }
