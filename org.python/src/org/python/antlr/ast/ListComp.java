...
public static final PyType TYPE = PyType.fromClass(ListComp.class);
    ...
    public static PyObject ListComp_new(PyNewWrapper _new, boolean init, PyType subtype, PyObject[]
    args, String[] keywords) {
        return new ListComp(subtype);
    }
    ...
    public ListComp(Node token, expr elt, java.util.List<comprehension> generators) {
        super(TYPE, token);
        this.elt = elt;
        if (this.elt != null)
