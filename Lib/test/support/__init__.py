...
def threading_cleanup(*original_values):
    """No need to cleanup, the last threading running is already dangling in Jylang
    because the method handles are still holding the reference to the thread object
    """
    return
