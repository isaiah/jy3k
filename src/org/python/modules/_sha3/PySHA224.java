...
@ExposedType(name = "sha3_224")
public class PySHA224 extends PyObject {
    public static final PyType TYPE = PyType.fromClass(PySHA224.class);

    private MessageDigest md;

    @ExposedGet
    public final int block_size = 144;
    ...
    @ExposedMethod
    public PyObject sha3_224_digest() {
        return new PyBytes(md.digest(buffer.array()));
    }

    @ExposedMethod
    public PyObject sha3_224_hexdigest() {
    ...
    @ExposedMethod
    public PyObject sha3_224_update(PyObject val) {
